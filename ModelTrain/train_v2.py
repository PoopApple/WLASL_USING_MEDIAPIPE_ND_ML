...
def main(
    ...
    # ── Data pipeline ──
    output_dir = f"./dataset3.0/{NUM_WORDS}words"
    ...
    model_name = f"{base_model_name}_{NUM_WORDS}w_{timestamp}"
    ...
    print(f"Label mapping:  {output_dir}/word_to_ind_{NUM_WORDS}.json")
...
if __name__ == "__main__":
    ...
    RESUME_MODEL_PATH = "dataset3.0/2000words/bigru_bigger_v1_aug/asl_bigru_bigger_v1_aug_2000w_26-04-26__23-41_best.keras"
