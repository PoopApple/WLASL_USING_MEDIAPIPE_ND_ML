...
def doshit(vid_path = "./smaller_dataset/above/00430.mp4" , showvid = False , dopythonlists = False , printdebugdata = False, normalisearray = True):   
...
def process_one(input_path, output_path):
    ...
    try:
        total_num_frames,vid_path,NP_NORMALISED_LANDMARK_ALL_FRAMES = doshit(input_path)
...
def process_all(input_folder, output_folder , printdebug = True , num_workers = os.cpu_count()-1):
