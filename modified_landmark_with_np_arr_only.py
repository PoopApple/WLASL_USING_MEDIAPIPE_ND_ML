        ...
        if result_pose.pose_landmarks:
            ...
            for landmark_index, i in enumerate(needed_poses):
                NP_LANDMARK_ALL_FRAMES[frame_index, landmark_index] = [
                    result_pose.pose_landmarks.landmark[i].x - CENTER_OF_SHOULDER[0],
                    result_pose.pose_landmarks.landmark[i].y - CENTER_OF_SHOULDER[1],
                    result_pose.pose_landmarks.landmark[i].z - CENTER_OF_SHOULDER[2],
            ...
            for idx, hand_landmarks in enumerate(results.multi_hand_landmarks):
                ...
                for i in range(21):
                    NP_LANDMARK_ALL_FRAMES[frame_index][landmark_index + i] = [
                        hand_landmarks.landmark[i].x - CENTER_OF_SHOULDER[0],
                        hand_landmarks.landmark[i].y - CENTER_OF_SHOULDER[1],
